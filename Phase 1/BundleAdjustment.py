...
from BuildVisibilityMatrix import getIndexAndVisibilityMatrix
...
def bundle_adjustment_sparsity(X_f, inlier_feature_flag, camIndex):
    ...
    X_index, visibility_matrix = getIndexAndVisibilityMatrix(X_f.reshape(-1), inlier_feature_flag, camIndex)
...
def BundleAdjustment(X_complete, X_f, features_u, features_v, inlier_feature_flag, Rset, Cset, K, camIndex):
    ...
    X_index, visiblity_matrix = getIndexAndVisibilityMatrix(X_f, inlier_feature_flag, camIndex)
